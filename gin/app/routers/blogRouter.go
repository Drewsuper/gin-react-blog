...
func init_blog_router(g *gin.RouterGroup) {
	g.POST("/blog/find_by_id", blogHandler.FindBlogHandler)
	...
	g.POST("/blog/class/find_all_label", classHandler.FindAllClassLabel) //鉴权
	...
	g.POST("/blog/tag/find_all_label", tagHandler.FindAllTagsLabel) // 鉴权
}
